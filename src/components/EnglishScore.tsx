...
interface EnglishScoreProps {
  score: number | null;
  variant?: "compact" | "detailed";
  className?: string;
}

const EnglishScore = ({ score, variant = "compact", className = "" }: EnglishScoreProps) => {
  if (score === null) {
    return null;
  }
    ...
    <div className={`flex flex-col gap-2 ${className}`}>
      <div className="flex items-center gap-3">
        ...
        <div className="flex flex-col">
          <span className="text-xs text-muted-foreground font-mono">ENGLISH PROFICIENCY</span>
          <Badge 
